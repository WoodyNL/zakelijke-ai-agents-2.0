  ...
  variants: [
    {
      ...
      points: [
        "Binnengehaalde leads",
        "Gekwalificeerd vs. afgewezen",
        "Geboekte afspraken",
        "Responstijd",
      ],
    },
    {
      ...
      points: [
        "Concepten klaargezet",
        "Goedgekeurd door jou",
        "Wijzigingen waarvan geleerd",
        "Zelf versturen pas als jij het aanzet",
      ],
    },
    {
      icon: "message",
    ...
    },
    {
      ...
      points: [
        "Contacten → bezorgd → reactie",
        "Afspraken & klanten",
        "Afmeldingen & bounces",
        "Automatische opvolging bij geen reactie",
      ],
    },
  ],
...
export const AGENTS = {
  ...
  cards: [
    ...
    },
    {
      ...
      badge: "Standaard concept · jij beslist",
    },
    {
      icon: "message",
