...
function ChatbotEmbed() {
  ...
  if (!mounted) {
    return <div className="h-[420px] w-full animate-pulse rounded-2xl bg-white/5" aria-hidden="true" />;
  }
    ...
    <Section id="chat" labelledBy="chat-titel" tinted>
      <Container>
        <div className="flex flex-col items-center text-center">
          ...
          <Lead>
            Dit is precies zo&apos;n agent als wij bouwen, live op onze eigen site. Vraag hem naar de
            AI-scan, prijzen, doorlooptijd of wat een agent in jouw branche kan doen.
          </Lead>
        </div>
