...
/**
 * De vier tariefkaarten. Gedeeld door de homepage en /tarieven.
 * `ctaHref` moet op /tarieven naar de homepage-anker wijzen, want daar staat
 * geen contactformulier op de pagina zelf.
 */
export function PricingCards({ ctaHref = "#contact" }: { ctaHref?: string }) {
  return (
        ...
        <Reveal key={c.title} delay={i * 60}>
          ...
          >
            ...
            <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
              <h3 className="font-display text-[17px] font-bold tracking-tight whitespace-nowrap text-brand">
                {c.title}
              </h3>
              {"badge" in c && c.badge ? (
...
/** De losse tarieven als lijst, plus de voetnoten. Gedeeld met /tarieven. */
